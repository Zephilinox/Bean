...
#multiplayer game type names
  ...
  ("trade_explanation_fruit", "I'm just coming in from the orchards, where we grow fruit. We dry them for storage, or they can also be made into cider or vinegar."),
