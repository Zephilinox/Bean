...
# Reinforcements
  ...
  ("kingdom_4_reinforcements_c", "{!}kingdom_4_reinforcements_c", 0, 0, fac_commoners, 0,
    [
      (trp.nord_master_axeman, 2, 4),
      (trp.nord_master_hunter, 1, 2),
    ]
  ),
