 ...
 # reserved for future use. For backward compatibility, we need to use these triggers instead of creating new ones.
  ...
  (8,
    [
      ...
      (try_for_parties, ":party_no"),
        (assign, ":exit", 0), ##BEAN - Check to see if the player disabled sorting for their party, if so, skip it
        (try_begin),
        ...
        (else_try),
          ...
          (try_begin),
            (party_slot_eq, ":party_no", slot_town_lord, "trp_player"), ##BEAN - Check to see if the player has fief sorting for himself enabled
