...
# Vaegir watchman?
  ...
  [
    ...
    SKILLS(power_strike = 2, power_throw = 1, shield = 1, ironflesh = 2, athletics = 2),
    nord_face_younger_1, nord_face_old_2,
  ],
  ...
  [
    ...
    SKILLS(power_strike = 4, power_throw = 3, shield = 3, ironflesh = 3, athletics = 3),
    nord_face_younger_1, nord_face_old_2,
  ],
  ...
  [
    ...
    SKILLS(power_strike = 5, power_throw = 4, shield = 4, ironflesh = 4, athletics = 4),
    nord_face_younger_1, nord_face_old_2,
  ],
