    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),
        ...
        (assign, ":cur_troop", "trp_khergit_knight"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_4"),
        (assign, ":cur_troop", "trp_nord_knight"),
      (else_try),
    ...
    (ti_on_presentation_load,
      [
        ...
        (else_try),
          ...
          (try_for_range, ":item_no", 0, ":num_items"),
            (item_get_type, ":type", ":item_no"),
            (this_or_next|is_between, ":type", itp_type_head_armor, itp_type_pistol),
        ...
        (else_try),
          ...
          (try_for_range, ":item_no", 0, ":num_items"),
            ...
            (this_or_next|eq, ":type", itp_type_book),
  ...
  ("change_all_factions_color", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
        ...
        (troop_set_slot, "trp_temp_array_b", 2, 0xFF6400),
        (troop_set_slot, "trp_temp_array_b", 3, 0xFFD840),
        (troop_set_slot, "trp_temp_array_b", 4, 0x40FF40),
        (troop_set_slot, "trp_temp_array_b", 5, 0x4080FF),
        (troop_set_slot, "trp_temp_array_b", 6, 0xC484FF),
        (troop_set_slot, "trp_temp_array_b", 7, 0xC8C8E8),
        (troop_set_slot, "trp_temp_array_b", 8, 0xFF4040),
