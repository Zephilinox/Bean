  ...
  (6,
   [(gt, "$g_prisoner_recruit_troop_id", 0),
    ...
    (try_begin),
      ...
      (display_log_message, "@{reg1} {s1} {reg2?have:has} escaped from your party during the night.", color_bad_news), ##BEAN - Color Coded Messages
    (try_end),
    ...
    (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
      ...
      (try_for_range_backwards, ":i_stack", 0, ":num_stacks"),
        ...
        (try_begin),
          ...
          (call_script, "script_get_message_color", news_lord_freed, ":stack_troop"), ##BEAN - Color Codded Messages
          (display_log_message, "@{s1} of {s3} has been released from captivity.", reg20), ##BEAN - Color Codded Messages
        (try_end),
      (try_end),
    (try_end),
    ]),
  ...
  (12,
   [(try_for_range, ":center_no", centers_begin, centers_end),
      ...
      (try_begin),
        ...
        (display_log_message, "@Building of {s0} in {s4} has been completed.", color_hero_news), ##BEAN BEGIN - Color Codded Messages
      (try_end),
      (try_begin),
        (is_between, ":center_no", villages_begin, villages_end),
    ...
    (try_for_range, ":center_no", towns_begin, towns_end),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (display_message, "@{s1} has won the tournament at {s2}.", color_quest_and_faction_news), ##BEAN BEGIN - Color Codded Messages
  ...
  (3, #check to see if player's court has been captured
   [
     ...
     (try_begin),
       ...
       (display_message, "@Betrothal to {s5} expires", color_hero_news), ##BEAN BEGIN - Color Codded Messages
   ...
   ##diplomacy end+
      ...
      (try_begin),
        ...
        (try_begin),
		  ...
		  (display_message, "@{s1} has switched from {s2} to {s3}.", color_terrible_news),
        ...
        (else_try),
		  ...
		  (display_message, "@{s1} has switched from {s2} to {s3}.", color_great_news),
          (call_script, "script_add_notification_menu", "mnu_notification_troop_joined_players_faction", ":troop_no", ":faction_no"),
		(else_try),
		  (display_message, "@{s1} has switched from {s2} to {s3}.", color_neutral_news),
        (try_end),
		##BEAN END - Color Codded Messages
      (try_end),
    (try_end),
    ]),
