...
def write_python_header(postfx_params_list):
  file = open("./ID/ID_postfx_params.py","w")
...
def write_postfx_params(postfx_params_list):
  ...
  for postfx_param in postfx_params_list:
    ...
    ofile.write("  %s %s %s %s"  %(swytrailzro(params_list1[0]), swytrailzro(params_list1[1]), swytrailzro(params_list1[2]), swytrailzro(params_list1[3]) ))
    ofile.write("  %s %s %s %s"  %(swytrailzro(params_list2[0]), swytrailzro(params_list2[1]), swytrailzro(params_list2[2]), swytrailzro(params_list2[3]) ))
    ofile.write("  %s %s %s %s\n"%(swytrailzro(params_list3[0]), swytrailzro(params_list3[1]), swytrailzro(params_list3[2]), swytrailzro(params_list3[3]) ))
  ofile.close()
