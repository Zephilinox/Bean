...
def save_tableau_materials(variable_list,variable_uses,tag_uses,quick_strings):
  ...
  for tableau in tableaus:
    ...
    if ((tableau[0].startswith("game_")) or (tableau[0].startswith("multiplayer_"))):
      ofile.write("tab_%s %d %s %d %d %d %d %d %d"%(tableau[0], tableau[1], tableau[2], tableau[3], tableau[4], tableau[5], tableau[6], tableau[7], tableau[8]))
    else:  
      #ofile.write("%s %d %s %d %d %d %d %d %d"%(signature[(find_object(tableaus,convert_to_identifier(tableau[0])))%sign_length], tableau[1], tableau[2], tableau[3], tableau[4], tableau[5], tableau[6], tableau[7], tableau[8]))
      ofile.write("tab_%s %d %s %d %d %d %d %d %d"%(str(tableau_id), tableau[1], tableau[2], tableau[3], tableau[4], tableau[5], tableau[6], tableau[7], tableau[8]))
