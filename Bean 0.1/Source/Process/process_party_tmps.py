...
#    add_tag_use(tag_uses,tag_faction,party_template[4])
    ...
    #file.write("%s %s %d %d %d %d "%(signature[(find_object(party_templates,convert_to_identifier(party_template[0])))%sign_length],replace_spaces(party_template[1]),party_template[2],party_template[3], party_template[4], party_template[5]))
    file.write("pt_%s %s %d %d %d %d "%(str(i_pt),replace_spaces(party_template[1]),party_template[2],party_template[3], party_template[4], party_template[5]))
