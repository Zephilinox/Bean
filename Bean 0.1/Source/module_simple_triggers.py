    ...
    (try_for_range, ":center_no", towns_begin, towns_end),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (display_message, "@{s1} has won the tournament at {s2}.", color_quest_and_faction_news),
  ...
  (3, #check to see if player's court has been captured
   [
     ...
     (try_begin),
       ...
       (display_message, "@Betrothal to {s5} expires", color_hero_news),
...
#             (display_message, "str_marshal_warning"),
           (else_try),
             (display_message, "str_marshal_warning", color_bad_news),
           (try_end),
         (try_end),
       (else_try),
