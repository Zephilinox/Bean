    ...
    (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
      ...
      (try_for_range_backwards, ":i_stack", 0, ":num_stacks"),
        ...
        (try_begin),
          ...
          (display_log_message, "@{s1} of {s3} has been released from captivity.", color_quest_and_faction_news),
        (try_end),
      (try_end),
    (try_end),
    ]),
...
(4, 
   [(try_for_range, ":troop_no", active_npcs_begin, active_npcs_end),
      ...
      (try_begin),
        ...
        (display_message, "@{s1} has switched from {s2} to {s3}.", color_quest_and_faction_news),
        (try_begin),
