       ...
       (else_try),
         ...
         (try_begin),
           ...
           (try_begin),
             ...
             (display_message, "str_qst_follow_spy_noticed_you", color_quest_and_faction_news),
           (try_end),
         (else_try),
...
# Troublesome bandits
  (0.3, 0.0, 1.1, [(check_quest_active, "qst_troublesome_bandits"),
                  ...
                  [(display_message, "str_bandits_eliminated_by_another", color_quest_and_faction_news),
